...
from get_embbedings import get_embeddings_function
...
def load_documents(): # using pdf data
    loader = PyPDFDirectoryLoader(DATA_PATH)
    documents = loader.load()
    return documents

"""
def load_documents(): # if using markdown data, some conversion error on testing, not recommended
...
def calculate_chunk_ids(chunks):
    ...
    # This will create IDs like "data/topic1.pdf:2:3"
